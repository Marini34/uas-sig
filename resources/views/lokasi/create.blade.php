...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">Tambahkan Lokasi</div>
                    <div class="card-body">
                        <div id="map"></div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">Tambahkan Data Lokasi baru</div>
                    <div class="card-body">
                        <form action="{{ route('lokasi.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-3">
                                <label for="icon">Tipe Lokasi</label>
                                <input type="text" class="form-control @error('icon')
                                    is-invalid
                                @enderror" name="icon">
                                @error('icon')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-group my-3">
                                <label for="latitude">Tipe Lokasi</label>
